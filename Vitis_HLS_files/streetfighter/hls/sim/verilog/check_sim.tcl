...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.street_fighter_cnn.autotvin_gmem0.dat"
         "c.street_fighter_cnn.autotvin_input_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.street_fighter_cnn.autotvout_prediction.dat"
         "rtl.street_fighter_cnn.autotvout_confidence.dat"
         "rtl.street_fighter_cnn.autotvout_dbg_in0.dat"
         "rtl.street_fighter_cnn.autotvout_dbg_l1_0.dat"
         "rtl.street_fighter_cnn.autotvout_dbg_gap0.dat"
         "rtl.street_fighter_cnn.autotvout_dbg_score0.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
