...
`define AUTOTB_DUT      street_fighter_cnn
`define AUTOTB_DUT_INST AESL_inst_street_fighter_cnn
`define AUTOTB_TOP      apatb_street_fighter_cnn_top
`define AUTOTB_LAT_RESULT_FILE "street_fighter_cnn.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "street_fighter_cnn.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_street_fighter_cnn_top
...
`define AESL_DEPTH_confidence 1
`define AESL_DEPTH_dbg_in0 1
`define AESL_DEPTH_dbg_l1_0 1
`define AESL_DEPTH_dbg_gap0 1
`define AESL_DEPTH_dbg_score0 1
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.street_fighter_cnn.autotvin_gmem0.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "../tv/rtldatafile/rtl.street_fighter_cnn.autotvin_input_r.dat"
...
`define AUTOTB_TVOUT_prediction_out_wrapc  "../tv/rtldatafile/rtl.street_fighter_cnn.autotvout_prediction.dat"
`define AUTOTB_TVOUT_confidence_out_wrapc  "../tv/rtldatafile/rtl.street_fighter_cnn.autotvout_confidence.dat"
`define AUTOTB_TVOUT_dbg_in0_out_wrapc  "../tv/rtldatafile/rtl.street_fighter_cnn.autotvout_dbg_in0.dat"
`define AUTOTB_TVOUT_dbg_l1_0_out_wrapc  "../tv/rtldatafile/rtl.street_fighter_cnn.autotvout_dbg_l1_0.dat"
`define AUTOTB_TVOUT_dbg_gap0_out_wrapc  "../tv/rtldatafile/rtl.street_fighter_cnn.autotvout_dbg_gap0.dat"
`define AUTOTB_TVOUT_dbg_score0_out_wrapc  "../tv/rtldatafile/rtl.street_fighter_cnn.autotvout_dbg_score0.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 20;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 3628;
parameter LENGTH_confidence = 1;
parameter LENGTH_dbg_gap0 = 1;
parameter LENGTH_dbg_in0 = 1;
parameter LENGTH_dbg_l1_0 = 1;
parameter LENGTH_dbg_score0 = 1;
...
wire  gmem0_WVALID;
wire  gmem0_WREADY;
wire [127 : 0] gmem0_WDATA;
wire [15 : 0] gmem0_WSTRB;
wire  gmem0_WLAST;
wire [0 : 0] gmem0_WID;
