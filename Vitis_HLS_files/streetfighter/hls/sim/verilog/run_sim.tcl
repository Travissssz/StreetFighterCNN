...
if {[file isfile street_fighter_cnn.autotvin.dat]} {
	file delete -force street_fighter_cnn.autotvin.dat
}

if {[file isfile street_fighter_cnn.autotvout.dat]} {
	file delete -force street_fighter_cnn.autotvout.dat
}
