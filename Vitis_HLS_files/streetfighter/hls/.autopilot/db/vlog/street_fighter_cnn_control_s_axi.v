...
// ==============================================================
`timescale 1ns/1ps
(* DowngradeIPIdentifiedWarnings="yes" *) module street_fighter_cnn_control_s_axi
#(parameter
    ...
    input  wire [15:0]                   dbg_in0,
    input  wire [15:0]                   dbg_l1_0,
    input  wire [15:0]                   dbg_gap0,
    input  wire [15:0]                   dbg_score0,
...
localparam
    ...
    ADDR_PREDICTION_DATA_0 = 7'h1c,
    ADDR_PREDICTION_CTRL   = 7'h20,
    ADDR_CONFIDENCE_DATA_0 = 7'h2c,
    ADDR_CONFIDENCE_CTRL   = 7'h30,
    ADDR_DBG_IN0_DATA_0    = 7'h3c,
    ADDR_DBG_IN0_CTRL      = 7'h40,
    ADDR_DBG_L1_0_DATA_0   = 7'h4c,
    ADDR_DBG_L1_0_CTRL     = 7'h50,
    ADDR_DBG_GAP0_DATA_0   = 7'h5c,
    ADDR_DBG_GAP0_CTRL     = 7'h60,
    ADDR_DBG_SCORE0_DATA_0 = 7'h6c,
    ADDR_DBG_SCORE0_CTRL   = 7'h70,
    WRIDLE                 = 2'd0,
    WRDATA                 = 2'd1,
    WRRESP                 = 2'd2,
    WRRESET                = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [15:0]                   int_confidence = 'b0;
    reg  [15:0]                   int_dbg_in0 = 'b0;
    reg  [15:0]                   int_dbg_l1_0 = 'b0;
    reg  [15:0]                   int_dbg_gap0 = 'b0;
    reg  [15:0]                   int_dbg_score0 = 'b0;
        ...
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_CONFIDENCE_DATA_0: begin
                    rdata <= int_confidence[15:0];
                end
                ADDR_DBG_IN0_DATA_0: begin
                    rdata <= int_dbg_in0[15:0];
                end
                ADDR_DBG_L1_0_DATA_0: begin
                    rdata <= int_dbg_l1_0[15:0];
                end
                ADDR_DBG_GAP0_DATA_0: begin
                    rdata <= int_dbg_gap0[15:0];
                end
                ADDR_DBG_SCORE0_DATA_0: begin
                    rdata <= int_dbg_score0[15:0];
                end
            endcase
        end
    end
